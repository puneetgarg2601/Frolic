...
CONSTANCE_CONFIG = {
    'SITE_TITLE': ('Frolic  ', _('Title of this site!'), str),
    ...
    'SOCIAL_NETWORKS_FACEBOOK_URL': ('https://www.facebook.com', _('Social Networks - Facebook'), str),
    'SOCIAL_NETWORKS_TWITTER_URL': ('https://twitter.com/?lang=en', _('Social Networks - Twitter'), str),
    'SOCIAL_NETWORKS_SNAPCHAT_URL': ('https://www.snapchat.com/', _('Social Networks - Snapchat'), str),
    'SOCIAL_NETWORKS_INSTAGRAM_URL': ('https://www.instagram.com/', _('Social Networks - Instagram'), str),
